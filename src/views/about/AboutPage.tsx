            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 max-w-5xl mx-auto">
              <RevealSection className="space-y-6">
                ...
                <div className="space-y-4 text-secondary leading-relaxed">
                  ...
                  <p>
                    Existing tools felt frustrating. Canva was too manual. Most tools required
            ...
            <RevealSection className="max-w-5xl mx-auto">
              ...
              <div className="space-y-4 sm:space-y-6 max-w-4xl">
                {[
                  {
                    icon: Lock,
                    title: 'No participant uploads',
                    text: "I didn't want organizers uploading participant data to random servers just to send certificates.",
                  },
                  {
                    icon: Zap,
                    title: 'Runs locally',
                    text: 'Everything runs inside the browser so generation stays fast and private.',
                  },
                  {
                    icon: Users,
                    title: 'Built from a real workflow',
                    text: 'The tool follows the same workflow I originally used during college events and hackathons.',
                  },
                  {
                    icon: Shield,
                    title: 'Less setup, more shipping',
                    text: 'No accounts, no dashboards, no unnecessary setup. Upload, generate, send.',
                  },
                ].map((item) => (
                  <div
                    key={item.title}
                    className="group bg-muted/20 rounded-lg p-6 border border-border/50 hover:border-border transition-colors"
                  >
        ...
        <section className="py-16 md:py-24 border-t border-border/50">
          <div className="container-width">
            <RevealSection className="max-w-4xl mx-auto text-center">
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-6">Open Source</h2>
              <p className="text-secondary mb-8 max-w-2xl mx-auto leading-relaxed">
                Tools that handle participant data should be transparent. Every line of code is
                publicly available — inspect how we handle data, verify our privacy claims, or host
                your own version.
              </p>
              <Link
                href="https://github.com/akshatthakur22/MailMyCertficate"
